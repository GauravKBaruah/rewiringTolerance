...
tem_mets$connectance_gowervariance
...
net1 %v% "color" = ifelse(net1 %v% "groups" == "plants","darkgrey", "royalblue3" ) #"#b2182b", "#E69F00" )
...
net2 %v% "color" = ifelse(net2 %v% "groups" == "plants","darkgrey", "royalblue3" ) #"#b2182b", "#E69F00"
...
net3 %v% "color" = ifelse(net3 %v% "groups" == "plants","darkgrey", "royalblue3" ) #"#b2182b", "#E69F00"
...
net4 %v% "color" = ifelse(net4 %v% "groups" == "plants","darkgrey", "royalblue3" ) #"#b2182b", "#E69F00"
